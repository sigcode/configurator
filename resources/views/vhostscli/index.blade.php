            ...
            <div class="ui three column grid">
                ...
                <div class="five wide column">
                    <div class="ui two column grid">
                        <div class="seven wide column">
                            <div class="ui fitted toggle checkbox">
                                <input type="checkbox" class="cbphp" {{ (substr(phpversion(), 0, 3) == "8.0") ?
                            "checked='checked'" : "" }} id="cbphp80" data-php-version="80">
                                <label></label>
                            </div>
                        </div>
                        <div class="eight wide column">
                            <div class="labelCheckbox">PHP 8.0</div>
                        </div>
                    </div>
                </div>
                <div class="five wide column">
                    <div class="ui two column grid">
                        <div class="seven wide column">
                            <div class="ui fitted toggle checkbox">
                                <input type="checkbox" class="cbphp" {{ (substr(phpversion(), 0, 3) == "8.1") ?
                            "checked='checked'" : "" }} id="cbphp81" data-php-version="81">
                                <label></label>
                            </div>
                        </div>
                        <div class="eight wide column">
                            <div class="labelCheckbox">PHP 8.1</div>
                        </div>
                    </div>
                </div>
