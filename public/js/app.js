  ...
  vhosts.prototype.getStatus = function (statusSpan, contentdiv, servicename) {
    ...
    $.ajax({
      ...
      if (res.match(/Active: active \(running\)/g)) {
        ...
        $("." + statusSpan).find("i").removeClass("red");
        $("." + statusSpan).find("i").removeClass("stop");
      } else {
        $("." + statusSpan).find("i").removeClass("green");
        $("." + statusSpan).find("i").removeClass("play");
        $("." + statusSpan).find("i").addClass("red");
        $("." + statusSpan).find("i").addClass("stop");
      }
    });
  };
